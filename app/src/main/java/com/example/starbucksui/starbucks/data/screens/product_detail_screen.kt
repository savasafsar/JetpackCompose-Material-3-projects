...
import com.example.starbucksui.starbucks.data.navigation.home
import com.example.starbucksui.ui.theme.Background
import com.example.starbucksui.ui.theme.DarkGreen
import com.example.starbucksui.ui.theme.Gray400_1
    ...
    Column(
        ...
        Row(
            ...
            Row (
                ...
                Text(
                    text = stringResource(id = R.string._4_5), style = TextStyle(
                        fontSize = 18.sp,
                        fontWeight = W400,
                        color = Gray_1
                    ),
...
fun ShowProduct() {
    ...
    var couter by remember { mutableIntStateOf(0) }
...
@Composable
private fun ProductHeader(navHostController: NavHostController) {
    Row(
        modifier = Modifier.fillMaxWidth(),
        horizontalArrangement = Arrangement.SpaceBetween
    ) {
        AppIconComponent(icon = R.drawable.back, onClick = { navHostController.navigate(home) })
